...
class AgaOperator(BaseOperator):
    def __init__(self,
    ...
    def execute(self, context):
        ...
        if self.python_callable:
            ...
            xcom_data = context['task_instance'].xcom_pull(key='data')
            ...
            try:
                ...
                for record in records_to_insert:
                    ...
                    required_keys = ['date', 'name', 'code', 'num', 'rate']
        ...
        try:
            with session_local.begin():
                for record in records_to_insert:
                    existing_record = session_local.query(TableCbrf).filter_by(date=record['date'],
