...
from scripts.stg.order_system.pg_saver import UsersPgSaver
...
class UsersLoader:
    ...
    def __init__(self, collection_loader: UsersReader, pg_dest: PgConnect, pg_saver: UsersPgSaver, logger: Logger) -> None:
    ...
    def run_copy(self) -> int:
        with self.pg_dest.connection() as conn:
            ...
            load_queue = self.collection_loader.get_users(last_loaded_ts)
