...
from scripts.stg.order_system.pg_saver import RestaurantsPgSaver
...
class RestaurantLoader:
    ...
    def __init__(self, collection_loader: RestaurantReader, pg_dest: PgConnect, pg_saver: RestaurantsPgSaver, logger: Logger) -> None:
